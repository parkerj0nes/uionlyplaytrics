...
//        { id: 9, type: 'range', friendly: 'Range' }
  ...
  }]).controller(controllerId, ['common', 'widgetinterface', admin])

    function admin(common, widgetinterface) {
        var vm = this;
        vm.title = 'Admin';
        ...
        vm.dashboardOptionsTest = {
            widgetButtons: false,
            widgetDefinitions: (function (x) {
                console.log("[admin controller] : %o", x);
                return x;
            })(widgetinterface.getWidgetDefinitions()),
